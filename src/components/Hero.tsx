  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-background px-6 py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary/5 rounded-full blur-3xl transform rotate-45"></div>
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-3xl transform -rotate-12"></div>
      </div>
      <div className="max-w-4xl mx-auto text-center animate-fade-in transform perspective-1000">
        <div className="mb-6">
